...
public interface HemonucleoControllerOpenApi {
    ...
    @Operation(summary = "Cria um novo hemonúcleo", description = "Cria um novo hemonúcleo e o vincula ao usuário ADM.")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Atualiza um hemonúcleo específico", description = "Atualiza dados de um hemonúcleo específico.")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Desativa um hemonúcleo específico", description = "Desativa um hemonúcleo específico.")
    @ApiResponses(value = {
